    ...
    <div className="mx-auto flex flex-col">
      <div className="m-4">
        ...
        <div className="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400">
          ...
          {' '}
          The data can be accessed by anyone, please do not enter personal information.
        </div>
        <p className="font-bold mb-2">eg:</p>
        <p className="mb-2">
          <Image src="/api/counter" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
      </div>
      <div className="m-4">
        ...
        <p className="mb-2">
          <Image src="/api/counter?theme=asoul" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
        <p className="font-bold mb-2">moebooru</p>
        <p className="mb-2">
          <Image src="/api/counter?theme=moebooru" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
        <p className="font-bold mb-2">moebooru-h</p>
        <p className="mb-2">
          <Image src="/api/counter?theme=moebooru-h" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
        <p className="font-bold mb-2">rule34</p>
        <p className="mb-2">
          <Image src="/api/counter?theme=rule34" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
        <p className="font-bold mb-2">gelbooru</p>
        <p className="mb-2">
          <Image src="/api/counter?theme=gelbooru" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
        <p className="font-bold mb-2">gelbooru-h</p>
        <p className="mb-2">
          <Image src="/api/counter?theme=gelbooru-h" alt="nextjs-moe-counter" width={450} height={100} />
        </p>
      </div>
      <div className="m-4">
